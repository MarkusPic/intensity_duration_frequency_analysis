...
[Example Jupyter notebook for the commandline](https://markuspic.github.io/intensity_duration_frequency_analysis/examples/example_commandline) (or in the [docs](https://markuspic.github.io/intensity_duration_frequency_analysis/examples/example_python_api.html))

[Example Jupyter notebook for the python api](https://markuspic.github.io/intensity_duration_frequency_analysis/examples/example_python_api) (or in the [docs](https://markuspic.github.io/intensity_duration_frequency_analysis/examples/example_python_api.html))

[Example Jupyter notebook for the python api of the DWA 2025 methodology](https://markuspic.github.io/intensity_duration_frequency_analysis/examples/example_python_api_2025) (or in the [docs](https://markuspic.github.io/intensity_duration_frequency_analysis/examples/example_python_api_2025.html))
