...
class Kostra(object):
    ...
    def result_plot(self, min_duration=5.0, max_duration=720.0, xscale="linear"):
        from sww.libs.timeseries.plots.plots import std_plot
        ...
        std_plot(file, fig, open_plot=False, height_cm=21, width_cm=29.7)

    # ------------------------------------------------------------------------------------------------------------------
    def result_plotly(self, min_duration=1.0, max_duration=8640, xscale="linear"):
        from sww.libs.timeseries.plots.plotly_interface.plotly_interface import PlotlyAxes, Ax, Scatter
